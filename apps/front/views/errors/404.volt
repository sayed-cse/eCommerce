...
{# Begin #}
<?php 
header("Content-Security-Policy: default-src 'self' https: *.facebook.net *.facebook.com *.fbcdn.net *.fbsbx.com; object-src *.facebook.net *.facebook.com *.fbcdn.net *.fbsbx.com; base-uri 'self'; script-src 'self' 'nonce-$nonce' https: https://cdnjs.cloudflare.com *.facebook.net *.facebook.com *.fbcdn.net *.fbsbx.com; img-src 'self' data: *.facebook.net *.facebook.com *.fbcdn.net *.fbsbx.com; style-src 'self' 'unsafe-inline' fonts.googleapis.com; upgrade-insecure-requests; font-src 'self' data: fonts.gstatic.com; manifest-src 'self'; worker-src 'self'; media-src 'self'; form-action 'self'; frame-ancestors *.facebook.net *.facebook.com *.fbcdn.net *.fbsbx.com;"); ?>
<style type="text/css">
...
<section id="errorPage">
	<article class="item base">
		<div class="errDisp radiusTL radiusTR radiusBL radiusBR">
		    <div>
				  <h1 class="marginA txtCenter color666 fxxLarge txtShadow6">!404 ERROR!</h1>
				  <h2 class="marginA txtCenter colorFFF txtShadowE pad10x fMedium bg666">SORRY!! THE PAGE YOU REQUESTED CANNOT BE FOUND</h2>
				  <div class="txtCenter bold fSmall color444">You have tried to access a page which was moved, renamed, expired or might never existed.<br/>Perhaps you can head back to the sites homepage and see if you can find what you are looking for.<br/><br/>

...
<title></title>
<link></link>
<description>Your true justification could change lives!</description>
{% for post in posts %}
<item>
	<title>{{ post.product_title|e }}</title>
	<link xlink:type="simple" xlink:href="" xlink:show="new">{{url.getBaseUri('')~"details/"~post.product_title }}</link>
